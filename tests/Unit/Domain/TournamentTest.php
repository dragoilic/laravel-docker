...
class TournamentTest extends TestCase
{
    public function testPlaceStraightBet()
    {
        ...
        $tournament->placeStraightBet($player, 500, new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), $event));
    ...
    public function testPlaceStraightBetTournamentOver()
    {
        ...
        $tournament->placeStraightBet($player, 500, new BetItem(1, 'moneyline_away', GamePeriod::FULL_TIME(), $event));
    }
    ...
    public function testPlaceStraightBetInvalidEvent()
    {
        ...
        $tournament->placeStraightBet($player, 500, new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), clone $event));
    }
    ...
    public function testPlaceParlayBet()
    {
        ...
        $tournament->placeParlayBet(
            $player, 500,
            new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), $event),
            new BetItem(5, 'total_over', GamePeriod::FULL_TIME(), $event)
        );
    ...
    public function testPlaceParlayBetInvalidEvent()
    {
        ...
        $tournament->placeParlayBet(
            $player, 500,
            new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), clone $event),
            new BetItem(5, 'total_over', GamePeriod::FULL_TIME(), $event)
        );
    }
    ...
    public function testPlaceParlayBetCorrelatedEvents()
    {
        ...
        $tournament->placeParlayBet(
            $player, 500,
            new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), $event),
            new BetItem(5, 'spread_away', GamePeriod::FULL_TIME(), $event)
        );
    }
    ...
    public function testIsReadyForCompletion(Result $result, bool $evaluateBet, bool $autoend, bool $expectedResult)
    {
        ...
        $event = $tournament->getBettableEvents()->first();
        $player = $user->getTournamentPlayer($tournament);
        $tournament->placeStraightBet($player, 1000, new BetItem(2, 'moneyline_away', GamePeriod::FULL_TIME(), $event));
        ...
        if ($evaluateBet) {
            $apiEvent->updateLines(new Line('moneyline::away::fulltime', $period, Offer::AWAY, Offer::MONEYLINE, 200, null, Settlement::WON()));
            $bet->evaluate();
        }
