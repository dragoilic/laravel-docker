...
class Offer
{
    ...
    {
        if (in_array(self::FIRST_HALF, $this->tags)) {
            switch (true) {
                case in_array(self::TOTAL, $this->tags) && in_array(self::UNDER, $this->tags):
                    return 'total_under_firsthalf';
                case in_array(self::TOTAL, $this->tags) && in_array(self::OVER, $this->tags):
                    return 'total_over_firsthalf';
                case in_array(self::SPREAD, $this->tags) && in_array(self::HOME, $this->tags):
                    return 'spread_home_firsthalf';
                case in_array(self::SPREAD, $this->tags) && in_array(self::AWAY, $this->tags):
                    return 'spread_away_firsthalf';
                case in_array(self::MONEYLINE, $this->tags) && in_array(self::HOME, $this->tags):
                    return 'moneyline_home_firsthalf';
                case in_array(self::MONEYLINE, $this->tags) && in_array(self::AWAY, $this->tags):
                    return 'moneyline_away_firsthalf';
                }
        } else if (in_array(self::SECOND_HALF, $this->tags)) {
            switch (true) {
                case in_array(self::TOTAL, $this->tags) && in_array(self::UNDER, $this->tags):
                    return 'total_under_secondhalf';
                case in_array(self::TOTAL, $this->tags) && in_array(self::OVER, $this->tags):
                    return 'total_over_secondhalf';
                case in_array(self::SPREAD, $this->tags) && in_array(self::HOME, $this->tags):
                    return 'spread_home_secondhalf';
                case in_array(self::SPREAD, $this->tags) && in_array(self::AWAY, $this->tags):
                    return 'spread_away_secondhalf';
                case in_array(self::MONEYLINE, $this->tags) && in_array(self::HOME, $this->tags):
                    return 'moneyline_home_secondhalf';
                case in_array(self::MONEYLINE, $this->tags) && in_array(self::AWAY, $this->tags):
                    return 'moneyline_away_secondhalf';
                }
        } else {
            switch (true) {
                case in_array(self::TOTAL, $this->tags) && in_array(self::UNDER, $this->tags):
