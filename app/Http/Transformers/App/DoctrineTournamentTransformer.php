...
class DoctrineTournamentTransformer extends TransformerAbstract
{
    ...
    public function includeGames(Tournament $tournament)
    {
        ...
        usort($events, fn (TournamentEvent $a, TournamentEvent $b) => $a->getApiEvent()->getStartsAt() <=> $b->getApiEvent()->getStartsAt());
        return $this->collection($events, new DoctrineTournamentEventTransformer());
    }
