...
class User
{
    ...
    public function debitRedeemedCredits(int $amount)
    {
        if ($this->balance < $amount) {
            throw UserBalanceException::insufficientBalanceToRedeem($amount, $this->balance);
        }
        $this->balance -= $amount;
    }

    public function creditRegistrationBonus(int $credits) {
        $this->balance += $credits;
    }

    public function creditReferralBonus(int $credits) {
        $this->balance += $credits;
    }
    ...
    public function updateProfileFields(string $firstname, string $lastname, string $phone): void
    {
        $this->firstname = $firstname;
        $this->lastname = $lastname;
        $this->phone = $phone;
