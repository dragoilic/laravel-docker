...
use App\Http\Controllers\App\Api\EventOddCollection;
use App\Http\Controllers\App\Api\LeagueCollection;
use App\Http\Controllers\App\Api\MeController;
use App\Http\Controllers\App\Api\FacebookAuthController;
use App\Http\Controllers\App\Api\MeStatisticsController;
use App\Http\Controllers\App\Api\OddCollection;
use App\Http\Controllers\App\Api\SignUpController;
use App\Http\Controllers\App\Api\NotificationsController;
use App\Http\Controllers\App\Api\RankingController;
use App\Http\Controllers\App\Api\SportCollection;
use App\Http\Controllers\App\Api\PlayerBetsController;
...
use App\Http\Controllers\App\Api\RewardController;
use App\Http\Controllers\App\Api\UserRewardController;
...
$router->domain($app)->group(function (Router $router) {
    ...
    $router->get('/leagues', LeagueCollection::class . '@get');
    $router->get('/odds', OddCollection::class . '@get');
    $router->get('/odds/event/{eventId}', EventOddCollection::class . '@get');
    $router->get('/me/referralLink', MeController::class . '@getReferralLink');
    $router->get('/getEmailList', NotificationsController::class . '@getEmailList');
    $router->get('/getRankingList', RankingController::class . '@getRankingList');

    $router->post('/signin', AppSignInController::class . '@login');
    $router->post('/signup', SignUpController::class . '@post');
    $router->post('/me/refer-user', MeController::class . '@ReferUser');
    $router->post('/me/forgot-password', MeController::class . '@forgotPassword');
    $router->post('/me/reset-password', MeController::class . '@resetPassword');
    $router->get('/rewards', RewardController::class . '@get');
    ...
    $router->middleware('auth')->group(function (Router $router) {
        ...
        $router->get('/me/statistics', MeStatisticsController::class . '@get');
        $router->get('/legendary-wins', MeStatisticsController::class . '@getLegendaryWins');

        $router->get('/me/credits-history', MeStatisticsController::class . '@creditsHistory');
        $router->get('/me/bets', PlayerBetsController::class . '@get');
        ...
        $router->post('/me/handleUserInfoChanges', MeController::class . '@handleUserInfoChanges');
        ...
        $router->post('/claim-reward', UserRewardController::class . '@post');
        $router->get('/me/rewards', UserRewardController::class . '@get');
    });
});
